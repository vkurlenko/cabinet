...
{	
    ...
    public function actionFreeOrderForm()
    {
        ...
        if($model->load(Yii::$app->request->post()) /*&& $model->validate()*/){
            ...
            $save = $freeorder->save();
            //echo $freeorder->id;
            /*echo $_FILES['FreeOrderForm']['tmp_name']['images'];
            $freeorder->attachImage($_FILES['FreeOrderForm']['tmp_name']['images']);*/

            /*$file = 'D:/OpenServer/domains/cabinet.andreychef/temp/orn_roz.png';
